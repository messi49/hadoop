...
public class TestFairSchedulerFairShare extends FairSchedulerTestBase {
  ...
  private void createClusterWithQueuesAndOneNode(int mem, int vCores, int gmem,
    ...
    RMNode node1 = MockNodes.newNodeInfo(1,
        Resources.createResource(mem, vCores, gmem), 1, "127.0.0.1");
  ...
  public void testFairShareWithDRFMultipleActiveQueuesUnderDifferentParent()
    ...
    int nodeMem = 16 * 1024;
    int nodeVCores = 10;
    createClusterWithQueuesAndOneNode(nodeMem, nodeVCores, 128,  "drf");
