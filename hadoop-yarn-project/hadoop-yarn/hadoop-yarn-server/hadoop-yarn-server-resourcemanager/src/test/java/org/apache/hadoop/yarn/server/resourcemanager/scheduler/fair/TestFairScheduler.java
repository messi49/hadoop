...
public class TestFairScheduler extends FairSchedulerTestBase {
  ...
  public void testAggregateCapacityTracking() throws Exception {
    ...
    RMNode node1 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(1024, 256), 1, "127.0.0.1");
    ...
    // Add another node
    RMNode node2 =
        MockNodes.newNodeInfo(1, Resources.createResource(512, 256), 2, "127.0.0.2");
  ...
  public void testSimpleFairShareCalculation() throws IOException {
    ...
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(10 * 1024, 256), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testFairShareWithMaxResources() throws IOException {
    ...
    // Add one big node (only care about aggregate capacity)
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(8 * 1024, 8, 1536), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testSimpleHierarchicalFairShareCalculation() throws IOException {
    ...
    int capacity = 10 * 24;
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(capacity, 256), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testSchedulerRootQueueMetrics() throws Exception {
    ...
    // Add a node
    RMNode node1 = MockNodes.newNodeInfo(1, Resources.createResource(1024, 256));
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
    ...
    RMNode node2 = MockNodes.newNodeInfo(1, Resources.createResource(1024, 256));
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
  ...
  public void testSimpleContainerAllocation() throws IOException {
    ...
    RMNode node1 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(1024, 4, 256), 1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);

    // Add another node
    RMNode node2 =
        MockNodes.newNodeInfo(1, Resources.createResource(512, 2, 128), 2, "127.0.0.2");
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);
  ...
  public void testSimpleContainerReservation() throws Exception {
    ...
    RMNode node2 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(1024, 256), 2, "127.0.0.2");
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    NodeUpdateSchedulerEvent updateEvent2 = new NodeUpdateSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);
    scheduler.handle(updateEvent2);
  ...
  public void testFairShareWithMinAlloc() throws Exception {
    ...
    // Add one big node (only care about aggregate capacity)
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(3 * 1024, 256), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testFairShareAndWeightsInNestedUserQueueRule() throws Exception {
    ...
    RMNode node1 = MockNodes.newNodeInfo(1, Resources.createResource(capacity, 256),
        1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testSteadyFairShareWithReloadAndNodeAddRemove() throws Exception {
    ...
    RMNode node1 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(6144, 256), 1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testChoiceOfPreemptedContainers() throws Exception {
    ...
    // Create two nodes
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(4 * 1024, 4, 256), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);

    RMNode node2 =
        MockNodes.newNodeInfo(1, Resources.createResource(4 * 1024, 4, 256), 2,
            "127.0.0.2");
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);
    ...
    scheduler.preemptResources(Resources.createResource(2 * 1024, 256));
    assertEquals(2, scheduler.getSchedulerApp(app1).getLiveContainers().size());
    assertEquals(2, scheduler.getSchedulerApp(app3).getLiveContainers().size());
  ...
  public void testPreemptionIsNotDelayedToNextRound() throws Exception {
    ...
    RMNode node1 = MockNodes.newNodeInfo(1,
        Resources.createResource(8 * 1024, 8, 256), 1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testPreemptionDecision() throws Exception {
    ...
    // Create four nodes
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(2 * 1024, 2, 256), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);

    RMNode node2 =
        MockNodes.newNodeInfo(1, Resources.createResource(2 * 1024, 2, 256), 2,
            "127.0.0.2");
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);

    RMNode node3 =
        MockNodes.newNodeInfo(1, Resources.createResource(2 * 1024, 2, 256), 3,
            "127.0.0.3");
  ...
  public void testPreemptionDecisionWithVariousTimeout() throws Exception {
    ...
    // Create one big node
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(6 * 1024, 6, 512), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testUserMaxRunningApps() throws Exception {
    ...
    RMNode node1 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(8192, 8, 511), 1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testMultipleNodesSingleRackRequest() throws Exception {
    ...
    RMNode node3 =
        MockNodes
            .newNodeInfo(2, Resources.createResource(1024, 256), 3, "127.0.0.3");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);
  ...
  public void testFifoWithinQueue() throws Exception {
    ...
    RMNode node1 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(3072, 3, 432), 1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testMaxAssign() throws Exception {
    ...
    RMNode node =
        MockNodes.newNodeInfo(1, Resources.createResource(16384, 16, 1536), 0,
            "127.0.0.1");
  ...
  public void testAssignContainer() throws Exception {
    ...
    RMNode node1 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(8192, 8, 1536), 1, "127.0.0.1");
    RMNode node2 =
        MockNodes
            .newNodeInfo(1, Resources.createResource(8192, 8, 1536), 2, "127.0.0.2");
  ...
  public void testRemoveNodeUpdatesRootQueueMetrics() throws IOException {
    ...
    RMNode node1 = MockNodes.newNodeInfo(1, Resources.createResource(1024, 4, 128), 1,
        "127.0.0.1");
  ...
  public void testStrictLocality() throws IOException {
    ...
    RMNode node1 = MockNodes.newNodeInfo(1, Resources.createResource(1024, 256), 1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);

    RMNode node2 = MockNodes.newNodeInfo(1, Resources.createResource(1024, 256), 2, "127.0.0.2");
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);
  ...
  public void testNoMoreCpuOnNode() throws IOException {
    ...
    RMNode node1 = MockNodes.newNodeInfo(1, Resources.createResource(2048, 1, 128),
        1, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
  ...
  public void testQueueMaxAMShare() throws Exception {
    ...
    RMNode node =
        MockNodes.newNodeInfo(1, Resources.createResource(20480, 20, 1538),
            0, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent = new NodeAddedSchedulerEvent(node);
    NodeUpdateSchedulerEvent updateEvent = new NodeUpdateSchedulerEvent(node);
    scheduler.handle(nodeEvent);
    ...
    Resource amResource1 = Resource.newInstance(1024, 1, 256);
    Resource amResource2 = Resource.newInstance(2048, 2, 512);
    Resource amResource3 = Resource.newInstance(1860, 2, 480);
  ...
  public void testQueueMaxAMShareDefault() throws Exception {
    ...
    RMNode node =
        MockNodes.newNodeInfo(1, Resources.createResource(8192, 20, 1538),
            0, "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent = new NodeAddedSchedulerEvent(node);
    NodeUpdateSchedulerEvent updateEvent = new NodeUpdateSchedulerEvent(node);
    scheduler.handle(nodeEvent);
  ...
  public void testContinuousScheduling() throws Exception {
    ...
    scheduler.handle(nodeEvent1);
    RMNode node2 =
            MockNodes.newNodeInfo(1, Resources.createResource(8 * 1024, 8, 1536), 2,
                    "127.0.0.2");
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);
    ...
    while (app.getCurrentConsumption()
            .equals(Resources.createResource(1024, 1, 128))) { }
  ...
  public void testContinuousSchedulingWithNodeRemoved() throws Exception {
    ...
    // Add two nodes
    RMNode node1 =
        MockNodes.newNodeInfo(1, Resources.createResource(8 * 1024, 8, 256), 1,
            "127.0.0.1");
    NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1);
    scheduler.handle(nodeEvent1);
    RMNode node2 =
        MockNodes.newNodeInfo(1, Resources.createResource(8 * 1024, 8, 256), 2,
            "127.0.0.2");
    NodeAddedSchedulerEvent nodeEvent2 = new NodeAddedSchedulerEvent(node2);
    scheduler.handle(nodeEvent2);
  ...
  public void testRecoverRequestAfterPreemption() throws Exception {
    ...
    RMNode node = MockNodes.newNodeInfo(1,
        Resources.createResource(16 * 1024, 4, 256), 0, host);
    NodeAddedSchedulerEvent nodeEvent = new NodeAddedSchedulerEvent(node);
    scheduler.handle(nodeEvent);
  ...
  public void testBlacklistNodes() throws Exception {
    ...
    String host = "127.0.0.1";
    RMNode node =
        MockNodes.newNodeInfo(1, Resources.createResource(16 * GB, 16, 1536),
            0, host);
    NodeAddedSchedulerEvent nodeEvent = new NodeAddedSchedulerEvent(node);
    NodeUpdateSchedulerEvent updateEvent = new NodeUpdateSchedulerEvent(node);
    scheduler.handle(nodeEvent);
  ...
  public void testMoveRunnableApp() throws Exception {
    ...
    RMNode node = MockNodes.newNodeInfo(1, Resources.createResource(1024, 256));
    NodeAddedSchedulerEvent nodeEvent = new NodeAddedSchedulerEvent(node);
    NodeUpdateSchedulerEvent updateEvent = new NodeUpdateSchedulerEvent(node);
    scheduler.handle(nodeEvent);
    scheduler.handle(updateEvent);
    
    assertEquals(Resource.newInstance(1024, 1, 256), oldQueue.getResourceUsage());
    scheduler.update();
    assertEquals(Resource.newInstance(3072, 3, 512), oldQueue.getDemand());
    ...
    assertEquals(Resource.newInstance(1024, 1, 256), targetQueue.getResourceUsage());
    ...
    assertEquals(Resource.newInstance(3072, 3, 512), targetQueue.getDemand());
  }
  ...
  public void testMoveWouldViolateMaxResourcesConstraints() throws Exception {
    ...
    scheduler.getAllocationConfiguration().maxQueueResources.put("root.queue2",
        Resource.newInstance(1024, 1, 256));

    ApplicationAttemptId appAttId =
        createSchedulingRequest(1024, 1, "queue1", "user1", 3);
    RMNode node = MockNodes.newNodeInfo(1, Resources.createResource(2048, 2, 256));
    NodeAddedSchedulerEvent nodeEvent = new NodeAddedSchedulerEvent(node);
    NodeUpdateSchedulerEvent updateEvent = new NodeUpdateSchedulerEvent(node);
    scheduler.handle(nodeEvent);
    scheduler.handle(updateEvent);
    ...
    assertEquals(Resource.newInstance(2048, 2, 512), oldQueue.getResourceUsage());
    scheduler.moveApplication(appAttId.getApplicationId(), "queue2");
  }
