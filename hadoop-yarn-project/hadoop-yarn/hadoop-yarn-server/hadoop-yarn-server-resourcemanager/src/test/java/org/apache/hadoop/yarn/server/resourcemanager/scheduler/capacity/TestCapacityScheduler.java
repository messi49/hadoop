  ...
  public void testCapacityScheduler() throws Exception {
    ...
    org.apache.hadoop.yarn.server.resourcemanager.NodeManager nm_0 = 
      registerNode(host_0, 1234, 2345, NetworkTopology.DEFAULT_RACK, 
          Resources.createResource(4 * GB, 1, 128));
    
    // Register node2
    String host_1 = "host_1";
    org.apache.hadoop.yarn.server.resourcemanager.NodeManager nm_1 = 
      registerNode(host_1, 1234, 2345, NetworkTopology.DEFAULT_RACK, 
          Resources.createResource(2 * GB, 1, 128));
    ...
    Resource capability_0_0 = Resources.createResource(1 * GB, 1, 128);
    application_0.addResourceRequestSpec(priority_1, capability_0_0);
    
    Resource capability_0_1 = Resources.createResource(2 * GB, 1, 128);
    ...
    Resource capability_1_0 = Resources.createResource(3 * GB, 1, 128);
    application_1.addResourceRequestSpec(priority_1, capability_1_0);
    
    Resource capability_1_1 = Resources.createResource(2 * GB, 1, 128);
 ...
 * @throws IOException
  ...
  public void testMoveAppForMoveToQueueWithFreeCap() throws Exception {
    ...
    Resource capability_1_0 = Resources.createResource(1 * GB, 1, 128);
    application_1.addResourceRequestSpec(priority_1, capability_1_0);
  ...
  public void testMoveAppSuccess() throws Exception {
    ...
    NodeManager nm_0 =
        registerNode(host_0, 1234, 2345, NetworkTopology.DEFAULT_RACK,
            Resources.createResource(5 * GB, 1, 128));
    ...
    Resource capability_0_0 = Resources.createResource(3 * GB, 1, 128);
    application_0.addResourceRequestSpec(priority_1, capability_0_0);
  ...
  public void testMoveAppViolateQueueState() throws Exception {
    ...
    NodeManager nm_0 =
        registerNode(host_0, 1234, 2345, NetworkTopology.DEFAULT_RACK,
            Resources.createResource(6 * GB, 1, 128));
  ...
  public void testAppReservationWithDominantResourceCalculator() throws Exception {
    ...
    MockNM nm1 = rm.registerNode("127.0.0.1:1234", 10 * GB, 1, 256);

    // register extra nodes to bump up cluster resource
    MockNM nm2 = rm.registerNode("127.0.0.1:1235", 10 * GB, 4, 256);
    rm.registerNode("127.0.0.1:1236", 10 * GB, 4, 256);
