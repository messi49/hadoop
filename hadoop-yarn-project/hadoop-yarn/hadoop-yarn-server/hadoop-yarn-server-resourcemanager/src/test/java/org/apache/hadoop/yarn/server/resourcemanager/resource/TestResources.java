...
public class TestResources {
  ...
  public void testFitsIn() {
    ...
    assertFalse(fitsIn(createResource(2, 1, 2), createResource(1, 2, 1)));
  }
  
  @Test(timeout=1000)
  public void testComponentwiseMin() {
    assertEquals(createResource(1, 1, 1),
        componentwiseMin(createResource(1, 1, 1), createResource(2, 2, 1)));
    assertEquals(createResource(1, 1, 1),
        componentwiseMin(createResource(2, 2, 1), createResource(1, 1, 1)));
    assertEquals(createResource(1, 1, 1),
        componentwiseMin(createResource(1, 2, 1), createResource(2, 1, 1)));
  }
}
