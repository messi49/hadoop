...
public class TestSchedulerUtils {
  ...
  public void testNormalizeRequestWithDominantResourceCalculator() {
    ...
    Resource minResource = Resources.createResource(1024, 1, 128);
    Resource maxResource = Resources.createResource(10240, 10, 256);
    Resource clusterResource = Resources.createResource(10 * 1024, 10, 256);
    ...
    SchedulerUtils.normalizeRequest(
        ask, resourceCalculator, clusterResource, minResource, maxResource);
    assertEquals(Resources.createResource(2048, 1, 256), ask.getCapability());
    assertEquals(1, ask.getCapability().getVirtualCores());
