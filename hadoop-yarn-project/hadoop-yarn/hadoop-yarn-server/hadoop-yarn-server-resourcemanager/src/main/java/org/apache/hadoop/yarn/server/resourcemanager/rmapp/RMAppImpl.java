  ...
  public ApplicationReport createAndGetApplicationReport(String clientUserName,
    ...
    try {
      ...
      if (allowAccess) {
        ...
        appUsageReport.setGpuMemorySeconds(rmAppMetrics.getGpuMemorySeconds());
      }
