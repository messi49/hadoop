...
public class TestProtocolRecords {
  ...
  public void testNMContainerStatus() {
    ...
    Resource resource = Resource.newInstance(1000, 200, 100);
  ...
  public void testRegisterNodeManagerRequest() {
    ...
    NMContainerStatus containerReport =
        NMContainerStatus.newInstance(containerId,
          ContainerState.RUNNING, Resource.newInstance(1024, 1, 256), "diagnostics",
    ...
    RegisterNodeManagerRequest request =
        RegisterNodeManagerRequest.newInstance(
          NodeId.newInstance("1.1.1.1", 1000), 8080,
            Resource.newInstance(1024, 1, 256), "NM-version-id", reports,
            Arrays.asList(appId));
    ...
    Assert.assertEquals(Resource.newInstance(1024, 1, 256),
